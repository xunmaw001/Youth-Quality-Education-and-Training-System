...
public class JiaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiaoshiEntity user = jiaoshiService.selectOne(new EntityWrapper<JiaoshiEntity>().eq("jiaoshibianhao", username));
    ...
    public R register(@RequestBody JiaoshiEntity jiaoshi){
    	...
    	JiaoshiEntity user = jiaoshiService.selectOne(new EntityWrapper<JiaoshiEntity>().eq("jiaoshibianhao", jiaoshi.getJiaoshibianhao()));
		if(user!=null) {
