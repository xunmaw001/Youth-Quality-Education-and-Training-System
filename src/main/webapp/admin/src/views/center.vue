  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="教师编号" prop="jiaoshibianhao">
          <el-input v-model="ruleForm.jiaoshibianhao" readonly              placeholder="教师编号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="个人简介" prop="gerenjianjie">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.jiaoshibianhao)&& 'jiaoshi'==this.flag){
