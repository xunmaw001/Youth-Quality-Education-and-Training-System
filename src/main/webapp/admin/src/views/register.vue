<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信小程序的青少年素质教育培训系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshibianhao" class="input" type="text" placeholder="教师编号">
			   </div>
			 </div> -->
			<el-form-item label="教师编号" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshibianhao" autocomplete="off" placeholder="教师编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
