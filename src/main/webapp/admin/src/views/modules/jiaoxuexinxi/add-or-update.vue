<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="上课年级" prop="shangkenianji">
          <el-input v-model="ruleForm.shangkenianji" 
              placeholder="上课年级" clearable  :readonly="ro.shangkenianji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="上课年级" prop="shangkenianji">
              <el-input v-model="ruleForm.shangkenianji" 
                placeholder="上课年级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程费用" prop="kechengfeiyong">
          <el-input v-model="ruleForm.kechengfeiyong" 
              placeholder="课程费用" clearable  :readonly="ro.kechengfeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程费用" prop="kechengfeiyong">
              <el-input v-model="ruleForm.kechengfeiyong" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教师编号" prop="jiaoshibianhao">
          <el-input v-model="ruleForm.jiaoshibianhao" 
              placeholder="教师编号" clearable  :readonly="ro.jiaoshibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教师编号" prop="jiaoshibianhao">
              <el-input v-model="ruleForm.jiaoshibianhao" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.jiaoshibianhao!=''&&json.jiaoshibianhao){
                this.ruleForm.jiaoshibianhao = json.jiaoshibianhao
	    		this.ro.jiaoshibianhao = true;
		}
	...
	this.ruleForm.kechengjieshao = this.ruleForm.kechengjieshao.replace(reg,'../../../ssmy4op0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
